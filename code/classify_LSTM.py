...
if __name__ == '__main__':
    ...
    #hyperparameter of the paper by Leuven
    hyperparameterPaper = Hyperparameter(4, 0, RMSprop, .001, 32, 20, .22, "tanh", 64)
 
    classify_LSTM(num_classes, num_days, hyperparameterPaper)
