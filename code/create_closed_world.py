...
from utils.util import number_traces_per_website

import re
from datetime import timedelta, datetime

def closed_world_foldername(nb_websites, days_after_first_collection):
	return "../data_cw{0}_day0_to_{1}/".format(nb_websites, days_after_first_collection)
...
def create_closed_world(nb_websites=20, max_days_after=10000, input_dir="../data/"):
	...
	new_directory = closed_world_foldername(nb_websites, max_days_after)
	...
	number_traces_per_website(new_directory)
